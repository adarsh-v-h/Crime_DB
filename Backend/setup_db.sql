-- ─── CRMS MySQL Setup ──────────────────────────────────────────────────────
-- Run this once to create the schema and seed it with demo data.
...
('Cyber Fraud — Wire Transfer Scam',
 'Victim received fraudulent email impersonating bank official. ₹12.5L transferred to unknown account. Digital forensics underway.',
...
('Real Estate Fraud — Land Document Forgery',
 'Forged land sale deed used to transfer property worth ₹3.2Cr. Forensic document analysis in progress.',
 'Fraud', 'Active', '2026-04-10', 'Jayanagar', 'Online'),

('ATM Card Skimming Ring',
 'Multi-city ATM skimming operation dismantled. 47 cloned cards recovered. ₹8.7L fraud prevented.',
 'Cyber Fraud', 'Solved', '2026-03-05', 'MG Road', 'Online'),

('Jewelry Heist — Commercial District',
 'Armed robbery at jewelry store. ₹45L worth of gold ornaments stolen. Case closed after recovery.',
...
('Investment Ponzi Scheme',
 'Fraudulent investment scheme targeting retirees. ₹1.8Cr collected from 34 victims. Financial forensics active.',
...
-- case 1 (Cyber Fraud — Wire Transfer)  → Arjun Nair (1), Vikram Rao (3)
INSERT INTO case_officer VALUES (1, 1), (1, 3);

-- case 2 (Vehicle Theft)  → Priya Menon (2)
INSERT INTO case_officer VALUES (2, 2);

-- case 3 (Assault)  → Deepa Krishnan (4), Ravi Kumar (5)
INSERT INTO case_officer VALUES (3, 4), (3, 5);

-- case 4 (Real Estate Fraud)  → Arjun Nair (1), Meera Iyer (6)
INSERT INTO case_officer VALUES (4, 1), (4, 6);

-- case 5 (ATM Skimming)  → Vikram Rao (3), Karthik S (7)
INSERT INTO case_officer VALUES (5, 3), (5, 7);

-- case 6 (Jewelry Heist)  → Priya Menon (2), Ravi Kumar (5)
INSERT INTO case_officer VALUES (6, 2), (6, 5);

-- case 7 (Domestic Violence)  → Deepa Krishnan (4)
INSERT INTO case_officer VALUES (7, 4);

-- case 8 (Ponzi Scheme)  → Meera Iyer (6), Karthik S (7)
INSERT INTO case_officer VALUES (8, 6), (8, 7);

-- case 9 (Data Breach)  → Arjun Nair (1), Vikram Rao (3), Karthik S (7)
INSERT INTO case_officer VALUES (9, 1), (9, 3), (9, 7);

-- case 10 (Mobile Snatching)  → Priya Menon (2), Ravi Kumar (5)
