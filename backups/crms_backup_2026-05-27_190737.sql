...
CREATE TABLE `cases` (
  ...
  `status` enum('Pending Review','Recommended','Assigned','Active','Solved','Closed','Rejected') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Pending Review',
...
-- Dump completed on 2026-05-27 19:07:37
